...
import com.ly.toolsproject.base.http.HttpInterface;
import com.ly.toolsproject.base.http.HttpRetrofit;
import com.ly.toolsproject.base.http.MainDataResponse;
import com.ly.toolsproject.base.http.ProgressFlowableSubscriber;
import com.ly.toolsproject.base.http.ProgressObservableSubscriber;
import com.ly.toolsproject.base.http.Response;
import com.ly.toolsproject.base.http.RxOperatorsFlowbleUtils;
...
public class MainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Observable<Object> compose = Observable.interval(1, TimeUnit.SECONDS)
                .compose(RxLifecycleAndroid.bindActivity(lifecycle()));
        compose.subscribe(new Consumer<Object>() {
            @Override
